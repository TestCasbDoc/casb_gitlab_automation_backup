...
class BaseActivity:
    ...
    def __init__(self, browser, app_config: dict, script_dir: str, capture_har: bool = False):
    ...
    def _before_send(self, page, tc_label: str):
        ...
        har = HarRecorder(page, tc_label, self.script_dir, capture_har=self.capture_har)
        har.start()
